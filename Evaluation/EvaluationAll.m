...
%     ResultAll(15,1)=Coverage;    
    ...
    MacroF1=Mac_F1(Pre_Labels,test_target);
    
    ResultAll(1,1) = 1 - HammingLoss;
    ResultAll(2,1) = 1 - RankingLoss;
    ResultAll(3,1) = Average_Precision;
    ResultAll(4,1) = 1 - OneError;
    ResultAll(5,1) = MacroF1;
    ResultAll(6,1) = Coverage;
