function [Xun_Means1,Xun_Stds1] = Total_MFS_MCDM(dataset)
...
Avg_Means1 = zeros(6,1);
Avg_Stds1 = zeros(6,1);
Xun_Means1 = zeros( 6,1);
Xun_Stds1 = zeros( 6,1);
m = 1;
k = 1;
n = 1;
...
while (m <= modelparameter.round)
    ...
    dataTrain = label_data;
    dataTrainLabels = label_target';
    [~,num_feature] = size(label_data);
    
    S1 = MFS_MCDM(dataTrain,dataTrainLabels);
    feature_idx = S1;
